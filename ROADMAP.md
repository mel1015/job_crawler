...
- **표본 확대**: 골든셋 20→30건 (2차 10건 추가, MAE 임계 11→12로 재설정). 30건 baseline MAE 10.5.
  2차에서 적합 백엔드 과소평가(클라우드/부가스택)·연차 미달 과소차감이 재확인 — 룰 추가 개선 후보.
- **남은 것**: 표본 추가 확대, 지원 결과(발전 5) 레이블 결합으로 골든셋 보강.
